...
<form target="_blank" name="fooForm" id="fooForm" method="GET" action="">
...
function goFrame() {
    ...
    for (var i = 0; i < name.length; i++) {
        nameInner.push((name[i].innerHTML).replace(",", "|").replace("#", ""));
    }

	window.open("https://twwkit.com/addList.php?accountName="+accountName+"&listid="+makeid(16)+"&itemnames="+nameInner+"&profilepic="+imgSrcs[0]);
}