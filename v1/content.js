...
<form target="_blank" name="fooForm" id="fooForm" method="GET" action="http://localhost/addList.php">
...
function goFrame() {
	...
	window.open("http://localhost/addList.php?accountName="+accountName+"&listid="+makeid(16)+"&itemnames="+nameInner+"&profilepic="+imgSrcs[0]);
}